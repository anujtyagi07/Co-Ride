        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Co-Ride</span>
            </div>
            <p className="text-gray-400 text-sm">
              Smart ride-sharing for Indian cities. Save money, make friends, travel sustainably.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><Link to="/legal?safety" className="hover:text-white transition-colors">Safety</Link></li>
            </ul>
          </div>
